...
@IBDesignable class CampersClosetTextField: UITextField {
    ...
    public var borderWidth1:CGFloat                          = 0.5{
        didSet{
    ...
    public var dtborderStyle:DTBorderStyle = .rounded{
        didSet{
            ...
            case .rounded:
                ...
                dtLayer.borderWidth         = borderWidth1
            ...
            case .bottom,.left,.right,.top:
                ...
                if dtborderStyle == .bottom {
                    borderLayer.frame = CGRect(x: 0, y: dtLayer.bounds.size.height - borderWidth1, width: dtLayer.bounds.size.width, height: borderWidth1)
                }else if dtborderStyle == .left{
                    borderLayer.frame = CGRect(x: 0, y: 0, width: borderWidth1, height: dtLayer.bounds.size.height)
                }else if dtborderStyle == .right{
                    borderLayer.frame = CGRect(x: dtLayer.bounds.size.width - borderWidth1, y: 0, width: borderWidth1, height: dtLayer.bounds.size.height)
                }else{
                    borderLayer.frame = CGRect(x: 0, y: 0, width: dtLayer.bounds.size.width, height: borderWidth1)
                }
    ...
    public var borderColor1:UIColor = UIColor(red: 204.0/255.0, green: 204.0/255.0, blue: 204.0/255.0, alpha: 1.0){
        didSet{
            switch dtborderStyle {
            case .none,.rounded,.sqare:
                dtLayer.borderColor = borderColor1.cgColor
            case .bottom,.right,.top,.left:
                borderLayer.backgroundColor = borderColor1.cgColor
            }
        }
    }
...
//    override public func leftViewRect1(forBounds bounds: CGRect) -> CGRect {
//        let rect = super.leftViewRect1(forBounds: bounds)
